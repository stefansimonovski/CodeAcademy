...
var RenderArtist = /** @class */ (function () {
    function RenderArtist() {
        var _this = this;
        this.artistData = {};
        this.renderAll = function (artistName) { return __awaiter(_this, void 0, void 0, function () {
            var _a, $mainContainer;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.artistPageData.getArtistPageData(artistName)];
                    case 1:
